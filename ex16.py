...
def covid_history():
    covid_movies = int(input("How many movies did you watch over COIVD? "))
    covid_lbs = int(input("How much lbs did you lose over COVID? "))
    covid_python = int(input("How long did you spend studying over COVID? "))
    together = """
